#!/bin/bash
# ============================================================================
# sentinex Vault -- Stellar Testnet Deployment Script
# ============================================================================
# Prerequisites:
...
stellar keys generate sentinex-owner \
    --network testnet \
    --fund \
    2>/dev/null || echo "[INFO] Key 'sentinex-owner' already exists"

echo "[DEPLOY] Generating AI agent keypair..."
stellar keys generate sentinex-agent \
    --network testnet \
    --fund \
    2>/dev/null || echo "[INFO] Key 'sentinex-agent' already exists"
...
CONTRACT_ID=$(stellar contract deploy \
    --wasm target/wasm32-unknown-unknown/release/sentinex_vault.optimized.wasm \
    --source sentinex-owner \
    --network testnet)
...
echo "  STELLAR_AGENT_SECRET=$(stellar keys show sentinex-agent)"
